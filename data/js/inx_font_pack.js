...
(function (global) {
   ...
   * 10–18 read advanceY straight off the bundled literata_<pt>_regular headers. There are no bundled sub-10pt
   * faces, so 6/8/9 extrapolate the same series (advanceY ~= 3.09 x pt); built-in families fall back to
   * their 10pt face at those steps, while SD families packed here render at true 6/8/9pt.
   */
  var SIZES = [6, 8, 9, 10, 12, 14, 16, 18];
   ...
   * @param {number} readerStep — 6|8|9|10|12|14|16|18 (filename suffix; canvas px from readerStepToCanvasPx)
